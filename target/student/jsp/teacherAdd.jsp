    ...
    <script type="text/javascript">
        if ('${addTeacher}' != '') {
            if ('${addTeacher}' == "成功") {
                ...
                if(con==false){
                    alert('点击取消！');
                    location.href = 'turnPage?page=teacherList'
                }
                if(con==true){
                    alert('点击确定！');
                }
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <div class="page-title">
            <div>
                <h1><i class="fa fa-edit"></i>新增教职工信息</h1>
                <p>请输入教职工信息，确认无误后点击提交</p>
            </div>
            <div>
                <ul class="breadcrumb">
                                ...
                                <fieldset>
                                    ...
                                    <form class="form-horizontal" action="/addTeacher" method="POST">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="text" name="tid" class="form-control inputxt"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label">姓名</label>
                                            <div class="col-lg-10">
                                                <input type="text" name="tname" class="form-control inputxt"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label">初始密码</label>
                                            <div class="col-lg-10">
                                                <input type="text" name="tpwd" class="form-control inputxt"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label">学院</label>
                                            <div class="col-lg-10">
                                                <input type="text" name="tacademy" class="form-control inputxt"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label">职衔</label>
                                            <div class="col-lg-10">
                                                <input type="text" name="ttag" class="form-control inputxt"/>
                                            </div>
                                        </div>
